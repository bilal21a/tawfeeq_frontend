    ...
    <div id="nav" class="nav-container d-flex">
        <div class="nav-content d-flex">
            ...
            <div class="user-container d-flex ms-md-7 ms-0">
                <a href="#" class="d-flex user position-relative ps-md-7 ps-0" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <img class="profile" alt="profile" src="homepage_img/man.png" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mt-3">
                                                        <img width="176px" height="176px" class="rounded-circle"
                                                            src="homepage_img/man.png" alt="" srcset="">
                                                    </div>
                                                </div>
